...
@Component({
  selector: 'app-collection-page-area',
  templateUrl: './collection-page-area.component.html',
  styleUrls: ['./collection-page-area.component.scss']
})
export class CollectionPageAreaComponent implements OnInit {
